              ...
              <div class="product-categories-one__inner">
                <ul>
                  <li> <a href="#0" class="img-box">
                      <div class="inner"> <img src="src/assets/images/shop/product-categories-v1-img1.png" alt="" />
                      </div>
                    </a>
                  ...
                  <li> <a href="#0" class="img-box">
                      <div class="inner"> <img src="src/assets/images/shop/product-categories-v1-img2.png" alt="" />
                      </div>
                    </a>
                    <div class="title"> <a href="#0">
                        <h6>Furnitures</h6>
                  ...
                  <li> <a href="#0" class="img-box">
                      <div class="inner"> <img src="src/assets/images/shop/product-categories-v1-img3.png" alt="" />
                      </div>
                    </a>
                    <div class="title"> <a href="#0">
                        <h6>Jewellery</h6>
                  ...
                  <li> <a href="#0" class="img-box">
                      <div class="inner"> <img src="src/assets/images/shop/product-categories-v1-img4.png" alt="" />
                      </div>
                    </a>
                    <div class="title"> <a href="#0">
                        <h6>Shoes</h6>
                  ...
                  <li> <a href="#0" class="img-box">
                      <div class="inner"> <img src="src/assets/images/shop/product-categories-v1-img5.png" alt="" />
                      </div>
                    </a>
                    <div class="title"> <a href="#0">
                        <h6>Electronics</h6>
                  ...
                  <li> <a href="#0" class="img-box">
                      <div class="inner"> <img src="src/assets/images/shop/product-categories-v1-img6.png" alt="" />
                      </div>
                    </a>
                    <div class="title"> <a href="#0">
                        <h6>Fashion</h6>
                            ...
                            <div :id="`popup${product.id}`" class="product-gird__quick-view-popup mfp-hide">
                              <div v-if="popupProduct" class="container">
                                <div class="row justify-content-between align-items-center">
                                  <div class="col-lg-6">
                                    <div class="quick-view__left-content" v-if="popupProduct.product_images.lenght > 2">
                                      <div class="tabs">
                                          ...
                                          <ul>
                                            ...
                                            <li v-for="productImage in popupProduct.product_images" class="tab-nav popup-product-thumb">
                                              <a :href="`#tabb1${productImage.id}`">
                                                <img :src="productImage.url" alt="" /> </a>
                                            </li>
                                        ...
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div v-for="productImage in popupProduct.product_images" :id="`tabb1${productImage.id}`" class="tab-item popup-product-image">
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="payment-method"> <a href="#0"> <img
                                        ...
                                        <a href="#0"> <img src="src/assets/images/payment_method/method_2.png" alt="">
                                        </a> <a href="#0"> <img src="src/assets/images/payment_method/method_3.png"
                                            alt=""> </a>
                    ...
                    <div class="tab-pane fade" id="pills-list" role="tabpanel" aria-labelledby="pills-list-tab">
                      <div class="row ">
                          ...
                          <div class="product-grid-two list mt-30 ">
                            <div class="product-grid-two__img">
                              <a href="shop-details-2.html" class="d-block"> <img
                                  src="src/assets/images/home-three/products-1.jpg" class="first-img" alt="" /> <img
                                  src="src/assets/images/home-three/products-hover-1.png" alt="" class="hover-img" /> </a>
                                          ...
                                          <ul>
                                            <li class="tab-nav popup-product-thumb">
                                              <a href="#tab7111111b"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img1.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab8111111b"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img2.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab9111111b"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img3.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                    ...
                                    <div class="quick-view__left-content">
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            <li class="tab-nav popup-product-thumb">
                                              <a href="#tab1z"> <img src="src/assets/images/shop/shop-grid-page-img2.jpg"
                                                  alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab2z"> <img src="src/assets/images/shop/shop-grid-page-img3.jpg"
                                                  alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab3z"> <img src="src/assets/images/shop/shop-grid-page-img4.jpg"
                                                  alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div id="tab3z" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img4.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                                    ...
                                    <div class="quick-view__left-content">
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            <li class="tab-nav popup-product-thumb">
                                              <a href="#tab4zz"> <img src="src/assets/images/shop/shop-grid-page-img3.jpg"
                                                  alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab5zz"> <img src="src/assets/images/shop/shop-grid-page-img4.jpg"
                                                  alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab6zz"> <img src="src/assets/images/shop/shop-grid-page-img5.jpg"
                                                  alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div id="tab6zz" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img5.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                                      ...
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            <li class="tab-nav popup-product-thumb">
                                              <a href="#tab44cc"> <img
                                                  src="src/assets/images/home-two/products-v5-img4.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab55cc"> <img
                                                  src="src/assets/images/home-two/products-v5-img5.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab66cc"> <img
                                                  src="src/assets/images/home-two/products-v5-img6.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          <div id="tab44cc" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/home-two/products-v5-img4.jpg" alt="" />
                                            </div>
                                          </div>
                                          <div id="tab55cc" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/home-two/products-v5-img5.jpg" alt="" />
                                            </div>
                                          </div>
                                          <div id="tab66cc" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/home-two/products-v5-img6.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                                      ...
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            <li class="tab-nav popup-product-thumb">
                                              <a href="#tab444vv"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img5.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab555vv"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img6.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab666vv"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img7.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div id="tab555vv" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img6.jpg" alt="" />
                                            </div>
                                          </div>
                                          <div id="tab666vv" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img7.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                                      ...
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            ...
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab14bb"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img8.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div id="tab14bb" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img8.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                                      ...
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            ...
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tab17nn"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img9.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div id="tab17nn" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img9.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img"> <a href="shop-details-2.html" class="d-block"> <img
                                  src="src/assets/images/home-three/productss2-2.jpg" class="first-img" alt="" /> <img
                                  src="src/assets/images/home-three/productss2-hover-2.png" alt="" class="hover-img" />
                              </a> </div>
                                      ...
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            <li class="tab-nav popup-product-thumb">
                                              <a href="#tabk1mm"> <img
                                                  src="src/assets/images/home-two/products-v5-img8.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tabk2mm"> <img
                                                  src="src/assets/images/home-two/products-v5-img4.jpg" alt="" /> </a>
                                            ...
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tabk3mm"> <img
                                                  src="src/assets/images/home-two/products-v5-img1.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          <div id="tabk1mm" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/home-two/products-v5-img8.jpg" alt="" />
                                            </div>
                                          </div>
                                          ...
                                          <div id="tabk3mm" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/home-two/products-v5-img1.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img">
                              <a href="shop-details-2.html" class="d-block">
                                <img src="src/assets/images/home-three/productss2-3.jpg" alt="" /> </a>
                            </div>
                                      ...
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            ...
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tabr2jj"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img10.jpg" alt="" /> </a>
                                            </li>
                                            <li class="tab-nav popup-product-thumb ">
                                              <a href="#tabr3jj"> <img
                                                  src="src/assets/images/shop/shop-grid-page-img11.jpg" alt="" /> </a>
                                            </li>
                                          </ul>
                                        </div>
                                        <div class="popup-product-main-image-box">
                                          ...
                                          <div id="tabr2jj" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img10.jpg" alt="" />
                                            </div>
                                          </div>
                                          <div id="tabr3jj" class="tab-item popup-product-image">
                                            <div class="popup-product-single-image">
                                              <img src="src/assets/images/shop/shop-grid-page-img11.jpg" alt="" />
                                            </div>
                                          </div> <button class="prev"> <i class="flaticon-back"></i>
                                          </button> <button class="next"> <i class="flaticon-next"></i>
                                          </button>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img"> <a href="shop-details-2.html" class="d-block">
                                <img src="src/assets/images/home-three/productss2-4.jpg" alt="" /> </a> </div>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img"> <a href="shop-details-2.html" class="d-block"> <img
                                  src="src/assets/images/home-three/productss3-1.jpg" alt="" /> </a> </div>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img"> <a href="shop-details-2.html" class="d-block"> <img
                                  src="src/assets/images/home-three/productss3-2.jpg" alt="" /> </a> </div>
